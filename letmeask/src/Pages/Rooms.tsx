...
export function Room(){
    ...
    async function handleLikeQuestion(questionId: string, likeId:string|undefined) {
        ...
        if(likeId){
            await database.ref(`rooms/${roomId.id}/questions/${questionId}/likes/${likeId}`).remove()
        }else{
            const newLike = await database.ref(`rooms/${roomId.id}/questions/${questionId}/likes`).push({
                authorId: user?.id,
            })
        }
